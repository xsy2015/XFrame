...
import com.xsy.qrcode.decoding.CaptureActivityHandler;
import com.xsy.qrcode.decoding.InactivityTimer;
import com.xsy.qrcode.view.ViewfinderView;
...
public class CaptureFragment extends Fragment implements SurfaceHolder.Callback, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ll_light = (LinearLayout) view.findViewById(R.id.ll_light);
